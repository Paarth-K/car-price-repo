...
page_dict = {"Home":home, "View Data":data, "Visualize Data":plot, "Price Prediction":predict}

st.sidebar.title("Navigation")
your_choice = st.sidebar.radio("Go To:", tuple(page_dict.keys()))

if your_choice=="Home":
	home.app()
else:
	select_page=page_dict[your_choice]
	select_page.app(final_cars_df)
